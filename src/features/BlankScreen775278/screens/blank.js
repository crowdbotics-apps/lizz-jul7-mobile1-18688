...
export class _Blank extends React.Component {
  ...
  state = {
    Input_2: "text input",
    Input_3: "1",
    Datepicker_4: new Date("07/07/2020"),
    Input_5: "textarea input",
    Input_7: "",
    Datepicker_25: new Date("07/07/2020"),
    Input_26: "",
    Input_24: ""
  }
  ...
  render = () => (
    ...
    >
      <Input
        ...
        editable={true}
        textStyle={{ fontSize: 10, color: "#f72222" }}
        style={{
          width: "100%",
          marginLeft: 0,
          marginRight: 0,
      ...
      <Input
        ...
        textStyle={{ fontSize: 10, color: "#ff388e" }}
        style={{
          width: "100%",
          marginLeft: 0,
          marginRight: 0,
      ...
      <Input
        ...
        editable={true}
        multiline={true}
        textStyle={{ height: 100, fontSize: 10, color: "#ec3232" }}
        style={{
          width: "100%",
          marginLeft: 0,
          marginRight: 0,
      ...
      <Datepicker
        ...
        date={this.state.Datepicker_25}
        onSelect={nextValue => this.setState({ Datepicker_25: nextValue })}
      />
      <Input
        placeholder="Sample text input placeholder"
        editable={true}
